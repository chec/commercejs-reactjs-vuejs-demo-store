<template>
  <div class="flex flex-grow-1 items-center bg-black pv6">
    <div class="relative w-100 mw9 center ph2 pb4">
...
<script>
import LettersHeroBgSvg from '../assets/letters-hero-big.svg'
